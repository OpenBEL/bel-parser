...
#test supports_parameter_identifiers
    ...
    fail_unless(
            strcmp(
                bel_ast_flat_string(parse_term(line)),
...
#test supports_parameters_single_char
    ...
    fail_unless(
            strcmp(
                bel_ast_flat_string(parse_term(term1)),
    ...
    fail_unless(
            strcmp(
                bel_ast_flat_string(parse_term(term2)),
    ...
    fail_unless(
            strcmp(
                bel_ast_flat_string(parse_term(term3)),
...
#test supports_long_parameters
    ...
    fail_unless(
            strcmp(
                bel_ast_flat_string(parse_term(term)),
