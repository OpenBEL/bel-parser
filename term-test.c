...
#test supports_empty_term
    ...
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(line)),
                "TERM (null) (null) ") == 0,
            "[bel_parse_term] failed to parse empty term");
...
#test supports_parameter_identifiers
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse parameter identifier (e.g. 100009_r_at)");
...
#test supports_parameter_strings
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse parameter string (e.g. \"apoptotic process\")");
...
#test supports_parameters_without_namespace
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse parameter without namespace (e.g. AKT1)");
...
#test supports_parameters_with_namespace
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse parameter with namespace (e.g. HGNC:AKT1)");

#test supports_parameters_single_char
    char term1[LINE_CHAR_LEN] = "r(MGI:a)";
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(term1)),
                "TERM fx(r) ARG NV pfx(MGI) val(a) ARG (null) (null) ") == 0,
            "[bel_parse_term] failed to parse single character parameter (e.g. MGI:a)");

    char term2[LINE_CHAR_LEN] = "r(a)";
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(term2)),
                "TERM fx(r) ARG NV pfx((null)) val(a) ARG (null) (null) ") == 0,
            "[bel_parse_term] failed to parse single character parameter (e.g. a)");

    char term3[LINE_CHAR_LEN] = "pmod(P)";
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(term3)),
                "TERM fx(pmod) ARG NV pfx((null)) val(P) ARG (null) (null) ") == 0,
            "[bel_parse_term] failed to parse single character parameter (e.g. P)");
...
#test supports_long_parameters
    ...
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(term)),
            ...
            "[bel_parse_term] failed to parse long parameter (e.g. SCHEM:\"3,5,9-Trioxo-4-phosphaheptacosan-1-aminium, 7-(acetyloxy)-4-hydroxy-N,N,N-trimethyl-, hydroxide, inner salt, 4-oxide, (R)-\"");
...
#test supports_multiple_parameters
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse multiple parameters (e.g. AKT1, HGNC:AKT2, AKT3)");
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse multiple parameters (e.g. \"apoptotic process\", \"AFFX-18SRNAMur/X00686_5_at\")");
...
#test supports_nested_terms
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse nested terms (e.g. cat(p(HGNC:AKT1)) )");
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse nested terms (e.g. p(HGNC:AKT1, pmod(P,S,317)) )");
    ...
    fail_unless(
            strcmp(
                bel_ast_as_string(bel_parse_term(term4)),
...
#test supports_long_terms
    ...
    fail_unless(
            ...
            "[bel_parse_term] failed to parse long term (e.g. rxn(reactants(a(CHEBI:testosterone),p(EGID:1666),p(EGID:1666),p(EGID:1666),a(SCHEM:Oxygen),a(SCHEM:Oxygen),a(SCHEM:Oxygen),a(SCHEM:\"H+\"),a(SCHEM:\"H+\"),a(SCHEM:\"H+\")),products(a(SCHEM:\"Estradiol-17beta\"),a(SCHEM:\"NADP+\"),a(CHEBI:formate),a(SCHEM:H2O),a(SCHEM:H2O),a(SCHEM:H2O),a(SCHEM:H2O))) )");
